		...
		if(map[mapReference] && polyline){
			...
			if(polylineLocationsAsMapLocations.length !== 0){
				...
				if(polyline.addHandler){
					Microsoft.Maps.Events.addHandler(polylineObject, polyline.addHandler.type, 
						function (callback, data) { this.MakeCallback(callback, data) }.bind(this, polyline.addHandler.callback, polyline.addHandler.callbackData));
				}
